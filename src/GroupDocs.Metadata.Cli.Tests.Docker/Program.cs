...
namespace GroupDocs.Metadata.Cli.Tests.Docker
{
    class Program
    {
        ...
        {
            Assembly testAssembly = Assembly.LoadFrom("GroupDocs.Metadata.Cli.Tests.dll");
        ...
        {
            string[] ext = new string[] { "*.xml", "*.csv", "*.json", "*.xls", "*.xlsx"};
